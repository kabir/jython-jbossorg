 ...
 *
 * $Id: PyCursor.java 6524 2009-07-07 19:31:47Z fwierzbicki $
 *
...
public class PyCursor extends PyObject implements ClassDictInit, WarningListener {
  ...
  static public void classDictInit(PyObject dict) {
    ...
    dict.__setitem__("__version__", Py.newString("$Revision: 6524 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
